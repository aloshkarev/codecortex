...
*Canonical path: `agents/codecortex-patch-planner.md`; packaged in `agents/codecortex-patch-planner.md`.*

## Skill binding

Read [skills/codecortex-workflows/SKILL.md](../skills/codecortex-workflows/SKILL.md) (Patch planning section).
