...
*Canonical path: `agents/codecortex-pr-reviewer.md`; packaged in `agents/codecortex-pr-reviewer.md`.*

## Skill binding

Read [skills/codecortex-workflows/SKILL.md](../skills/codecortex-workflows/SKILL.md) (Branch / PR review section).
