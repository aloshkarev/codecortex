...
*Canonical path: `agents/codecortex-indexer.md`; packaged in `agents/codecortex-indexer.md`.*

## Skill binding

Read and follow [skills/codecortex-indexing/SKILL.md](../skills/codecortex-indexing/SKILL.md) before acting.
