...
*Canonical path: `docs/agents/codecortex-analyzer.md`; symlinked at `.cursor/agents/codecortex-analyzer.md`.*

## Skill binding

Read and follow [docs/skills/codecortex/SKILL.md](../skills/codecortex/SKILL.md).
